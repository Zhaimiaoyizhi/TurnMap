...
This document explains the permissions used by TurnMap `v0.8.4`.
...
- TurnMap is current-conversation scoped. It does not build a cross-conversation graph in `v0.8.4`.
...
The current permission set is acceptable for the local GitHub `v0.8.4` preview.
