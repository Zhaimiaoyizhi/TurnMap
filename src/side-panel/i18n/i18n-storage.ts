...
export const EN_TRANSLATIONS = {
  ...
  "app.action.refreshIndex": "Refresh Index",
  ...
  "app.status.refreshIndexAdded": "Index refresh added {added} available turns; {total} total.",
  "app.status.refreshIndexNoNew": "Index refresh found no new available turns; {total} total.",
  "app.status.restoredConversation": "Restored the saved map for this conversation with {count} turns.",
  "app.status.switchReadingIndex": "Refreshing this conversation index before switching maps...",
  ...
  "app.status.refreshingIndex": "Refreshing the available conversation index...",
  "app.status.refreshIndexFailed": "Index refresh could not reach the active conversation tab.",
  ...
  "debug.turns": "Turns",
  "debug.source": "Source",
  "debug.selectorTurns": "Selector turns",
  "debug.fallbackTurns": "Fallback turns",
  ...
  "settings.customSites.title": "Custom sites",
  "settings.customSites.hint": "Selector-only profiles are stored locally. An exact-origin permission and a successful preview are required before use.",
  "settings.customSites.name": "Display name",
  "settings.customSites.origin": "Exact origin",
  "settings.customSites.pathPattern": "Path pattern",
  "settings.customSites.conversationRoot": "Conversation root selector",
  "settings.customSites.userSelector": "User message selector",
  "settings.customSites.assistantSelector": "Assistant message selector",
  "settings.customSites.titleSelector": "Title selector (optional)",
  "settings.customSites.scrollContainer": "Scroll container selector (optional)",
  "settings.customSites.messageIdAttributes": "Stable ID attributes",
  "settings.customSites.selectorHint": "CSS selectors only. Scripts, broad wildcard origins, and built-in site overrides are rejected.",
  "settings.customSites.save": "Save disabled profile",
  "settings.customSites.cancel": "Cancel editing",
  "settings.customSites.savedDisabled": "Profile saved locally and disabled until validation succeeds.",
  "settings.customSites.invalid": "Profile validation failed.",
  "settings.customSites.validating": "Requesting exact-origin access and previewing the active page...",
  "settings.customSites.validateEnable": "Validate & enable",
  "settings.customSites.permissionDenied": "Exact-origin permission was not granted; the profile remains disabled.",
  "settings.customSites.previewFailed": "Preview failed; the profile remains disabled.",
  "settings.customSites.reason.permission-required": "Permission required",
  "settings.customSites.reason.preview-required": "Preview required",
  "settings.customSites.reason.permission-denied": "Permission denied",
  "settings.customSites.reason.preview-failed": "Preview failed",
  "settings.customSites.enabled": "Enabled",
  "settings.customSites.disabled": "Disabled",
  "settings.customSites.edit": "Edit",
  "settings.customSites.disable": "Disable",
  "settings.customSites.delete": "Delete",
  "settings.customSites.deleteConfirm": "Delete this custom site profile?",
  "settings.customSites.empty": "No custom site profiles yet.",
  "settings.customSites.previewSummary": "Active-page preview",
  "settings.customSites.importMode": "Import mode",
  "settings.customSites.merge": "Merge with local profiles",
  "settings.customSites.replace": "Replace local profiles",
  "settings.customSites.import": "Import custom sites",
  "settings.customSites.export": "Export custom sites",
  "settings.customSites.importDone": "Imported {count} profiles. Imported profiles remain disabled until validated.",
  "settings.customSites.importFailed": "Custom sites import failed.",
  "settings.customSites.exportDone": "Custom sites backup exported.",
  ...
  "floatingNavigator.view.all": "All turns",
  "floatingNavigator.view.favorites": "Favorites",
  "floatingNavigator.action.addFavorite": "Favorite this turn",
  "floatingNavigator.action.removeFavorite": "Remove from favorites",
  "floatingNavigator.action.jump": "Jump to this conversation turn",
  "floatingNavigator.empty.all": "No mapped turns yet.",
  "floatingNavigator.empty.favorites": "No favorite turns yet.",
  "floatingNavigator.unavailable": "Original turn is temporarily unavailable.",
  "floatingNavigator.turn": "Turn {number}",
  "promptWorkbench.content.optimize": "Optimize prompt",
  "promptWorkbench.content.imagePrompt": "Image prompt",
  ...
  "promptWorkbench.content.optimizeStage.readInput": "Failed while reading the current ChatGPT input. This is usually an input box or text selection issue, not an API key problem.",
  "promptWorkbench.content.optimizeStage.requestChatCompletion": "Failed while requesting your configured AI provider. Check the provider, model, quota, host permission, or network details below.",
  "promptWorkbench.content.optimizeStage.writeInput": "Failed while writing the optimized prompt back to the ChatGPT input box. The page may have remounted the editor.",
  "promptWorkbench.content.optimizeFailureHint": "The raw error below is sanitized and should help identify whether this is input reading, provider request, or write-back.",
  "promptWorkbench.content.openAiSettings": "Open AI settings",
  "promptWorkbench.content.copy": "Copy",
  "promptWorkbench.content.imagePromptConcept": "Start from the current input, then choose image prompt constraints below.",
  "promptWorkbench.content.imagePromptCustom": "Custom option...",
  "promptWorkbench.content.imagePromptAddCustom": "Add custom option",
  "promptWorkbench.content.imagePromptRandom": "Random",
  "promptWorkbench.content.imagePromptGenerate": "Optimize",
  "promptWorkbench.content.imagePromptSavePreset": "Save preset",
  "promptWorkbench.content.imagePromptPresetSaved": "Image prompt preset saved.",
...
export const ZH_TRANSLATIONS: TranslationMap = {
  ...
  "app.status.refreshIndexAdded": "索引刷新补充 {added} 个当前可用节点，共 {total} 个。",
  "app.status.refreshIndexNoNew": "索引刷新未发现新的当前可用节点，共 {total} 个。",
  "app.status.restoredConversation": "已恢复这个对话保存过的思维导图，共 {count} 个节点。",
  "app.status.switchReadingIndex": "切换思维导图前正在刷新这个对话的索引...",
  ...
  "app.status.refreshingIndex": "正在刷新当前可用的对话索引...",
  "app.status.refreshIndexFailed": "索引刷新无法连接到当前对话标签页。",
  ...
  "debug.turns": "轮次",
  "debug.source": "来源",
  "debug.selectorTurns": "选择器轮次",
  "debug.fallbackTurns": "备用选择器轮次",
  ...
  "settings.customSites.title": "自定义站点",
  "settings.customSites.hint": "仅使用选择器的配置仅保存在本地；必须授予精确域名权限并通过预览后才能启用。",
  "settings.customSites.name": "显示名称",
  "settings.customSites.origin": "精确来源域名",
  "settings.customSites.pathPattern": "路径模式",
  "settings.customSites.conversationRoot": "对话根节点选择器",
  "settings.customSites.userSelector": "用户消息选择器",
  "settings.customSites.assistantSelector": "助手消息选择器",
  "settings.customSites.titleSelector": "标题选择器（可选）",
  "settings.customSites.scrollContainer": "滚动容器选择器（可选）",
  "settings.customSites.messageIdAttributes": "稳定 ID 属性",
  "settings.customSites.selectorHint": "仅接受 CSS 选择器；脚本、宽泛通配来源和内置站点覆盖会被拒绝。",
  "settings.customSites.save": "保存为停用配置",
  "settings.customSites.cancel": "取消编辑",
  "settings.customSites.savedDisabled": "配置已保存在本地，验证成功前保持停用。",
  "settings.customSites.invalid": "配置验证失败。",
  "settings.customSites.validating": "正在请求精确域名权限并预览当前页面……",
  "settings.customSites.validateEnable": "验证并启用",
  "settings.customSites.permissionDenied": "未授予精确域名权限；配置仍保持停用。",
  "settings.customSites.previewFailed": "预览失败；配置仍保持停用。",
  "settings.customSites.reason.permission-required": "需要授予权限",
  "settings.customSites.reason.preview-required": "需要重新预览",
  "settings.customSites.reason.permission-denied": "权限被拒绝",
  "settings.customSites.reason.preview-failed": "预览失败",
  "settings.customSites.enabled": "已启用",
  "settings.customSites.disabled": "已停用",
  "settings.customSites.edit": "编辑",
  "settings.customSites.disable": "停用",
  "settings.customSites.delete": "删除",
  "settings.customSites.deleteConfirm": "删除此自定义站点配置？",
  "settings.customSites.empty": "暂无自定义站点配置。",
  "settings.customSites.previewSummary": "当前页面预览",
  "settings.customSites.importMode": "导入模式",
  "settings.customSites.merge": "与本地配置合并",
  "settings.customSites.replace": "替换本地配置",
  "settings.customSites.import": "导入自定义站点",
  "settings.customSites.export": "导出自定义站点",
  "settings.customSites.importDone": "已导入 {count} 个配置；导入项在验证前保持停用。",
  "settings.customSites.importFailed": "自定义站点导入失败。",
  "settings.customSites.exportDone": "自定义站点备份已导出。",
  ...
  "floatingNavigator.view.all": "全部问答",
  "floatingNavigator.view.favorites": "收藏",
  "floatingNavigator.action.addFavorite": "收藏此问答",
  "floatingNavigator.action.removeFavorite": "取消收藏",
  "floatingNavigator.action.jump": "跳转到此对话轮次",
  "floatingNavigator.empty.all": "暂未读取到对话轮次。",
  "floatingNavigator.empty.favorites": "还没有收藏的问答。",
  "floatingNavigator.unavailable": "原问答暂时无法定位。",
  "floatingNavigator.turn": "第 {number} 轮",
  "promptWorkbench.content.optimize": "优化提示词",
  "promptWorkbench.content.imagePrompt": "生图提示词",
  ...
  "promptWorkbench.content.optimizeStage.readInput": "读取当前 ChatGPT 输入时失败。这通常是输入框或文本选区问题，不是 API Key 问题。",
  "promptWorkbench.content.optimizeStage.requestChatCompletion": "请求你配置的 AI 服务时失败。请结合下方详情检查服务商、模型、额度、域名权限或网络。",
  "promptWorkbench.content.optimizeStage.writeInput": "将优化后的提示词写回 ChatGPT 输入框时失败。页面可能刚刚重挂载了输入框。",
  "promptWorkbench.content.optimizeFailureHint": "下方原始错误已脱敏，可用于判断问题发生在读取输入、请求模型，还是写回输入阶段。",
  "promptWorkbench.content.openAiSettings": "打开 AI 设置",
  "promptWorkbench.content.copy": "复制",
  "promptWorkbench.content.imagePromptConcept": "以当前输入为基础，再选择下方生图约束。",
  "promptWorkbench.content.imagePromptCustom": "自定义选项...",
  "promptWorkbench.content.imagePromptAddCustom": "添加自定义选项",
  "promptWorkbench.content.imagePromptRandom": "随机",
  "promptWorkbench.content.imagePromptGenerate": "优化",
  "promptWorkbench.content.imagePromptSavePreset": "保存预设",
  "promptWorkbench.content.imagePromptPresetSaved": "生图提示词预设已保存。",
